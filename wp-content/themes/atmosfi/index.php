...
<section id="index" class="my-slider">
	...
	<li>
	<img src="<?php echo get_template_directory_uri(); ?>/image/banner1.jpg" />
...
<div class="extrnal-menu">
	<span class="toggle3"><i class="fa fa-bars"></i></span>
	<ul class="drop-menu">
		<li class="activee">
		...
		<li>
			<a href="price.html">plans and pricing</a>
		</li>
		<li>
		...
		<!--	 <li class="sign1"><a href="#">sign up</a></li>  -->
		<li>
...
<section class="customer-section">
	<div class="container" id="customer">
		<div class="col-sm-5">
			<div class="customer">
				<h1>Customer</h1>
				<h3>Reteation Services</h3>
				<img src="<?php echo get_template_directory_uri(); ?>/image/border-logo.png" alt=""  class="border-logo" />
				<p>
					atmosFi provides the an easy to use tool for all local businesses to keep their customers coming back for future business. It requires no additional work and setup takes 5 minutes or less.
				</p>
...
<section id="home" data-speed="4" data-type="background" class="market">
	<div class="container">
		<div class="col-sm-5 directly">
			<h1>Market Directly</h1>
			<h3>to your customer</h3>
			<img src="<?php echo get_template_directory_uri(); ?>/image/border-logo1.png" alt="" class="border-logo1" />
			<p>
				AtmosFi collects customer contact information via WiFi interaction and uses this information to keep your customers coming back.
			</p>
		...
		<div class="col-sm-7 im2" id="tvBorder">
			...
			<div >
				<video class="videoat" style="width:100%; height:100%" controls preload="auto">
					<source src="<?php echo get_template_directory_uri(); ?>/final-video.mp4" frameborder="0" allowfullscreen>
				</video>
...
<section class="social">
	<div class="container">
		...
		<div class="col-sm-6 social-box">
			...
			<img src="<?php echo get_template_directory_uri(); ?>/image/border-logo.png" alt=""  class="border-logo" />
			<p>
				AtmosFi makes it easy for customers to share promotions, coupons, and alerts they receive from your business on Facebook, Twitter, and through Email. Customers can now share
				information about your business with their friends!
			</p>
			<div class="so">
				<ul class="list-inline">
					<li>
						<a href=" https://www.facebook.com/pages/AtmosFi-Wi-Fi/1575654606015117?sk=timeline" target="_blank" class="green"><i class="fa fa-facebook-square"></i></a>
					</li>
					<li>
						<a href=" https://twitter.com/AtmosFi_Wifi" target="_blank"><i class="fa fa-twitter"></i></a>
					</li>
					<li>
						<a href=" https://plus.google.com/b/107404069253463963294/107404069253463963294/about" target="_blank" class="green"><i class="fa fa-google-plus"></i></a>
					</li>
				</ul>
			</div>
...
<section id="home2" data-speed="4"  class="how">
	<div class="container">
		<div class="col-sm-12 it-works">
			...
			<p>
				AtmosFi is a turn key WiFi solution for your business.
			</p>
...
<section class="database">
	<div class="container">
		...
		<div class="col-sm-6 personal-text">
			...
			<img src="<?php echo get_template_directory_uri(); ?>/image/border-logo.png" alt=""  class="border-logo" />
			<p>
				AtmosFi enables your business to build a customer database allowing you to know how many customers you have, how often customer visits, busiest days/time, basic information on the customer and more. Deliver the same personal customer service you deliver in your business – digitally.
